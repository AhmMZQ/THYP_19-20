...
var formUrl = "https://forms.gle/Wp4Sbf173oUzASU88";
...
function setData(data) {
    ...
    var q = d3.queue()
        ...
        .awaitAll(function (error, results) {
            ...
            dataForm1.forEach(function (d, j) {
    ...
    d3.select("#dropDownStudents")
        ...
        .on('click', function (e, i) {
            ...
            if (e.adress != null)
                ...
                d3.select("#adress").html('<a href="' + formUrl + '" target="_blank">Ajoutez vos informations</a>');

            //Set phone number
            if (e.tel != null)
                d3.select("#phoneNumber").text(e["tel"]);
            else
                d3.select("#phoneNumber").html('<a href="' + formUrl + '" target="_blank">Ajoutez vos informations</a>');
            ...
            if (e.bio != null)
                ...
                d3.select("#bio").html('<a href="' + formUrl + '" target="_blank">Ajoutez vos informations</a>');
            ...
            if (e.facebook == null && e.twitter == null && e.linckedin == null && e.github == null) {
                d3.select("#socialMedia").append("span").html('<a href="' + formUrl + '" target="_blank">Ajoutez vos informations</a>');
            }
            else {
            ...
            if (e.Experience1 == null) {
                experienceElement.append("span").html('<a href="' + formUrl + '" target="_blank">Ajoutez vos informations</a>');
            }
            else {
            ...
            if (e.Nomdétablissement1 == null) {
                educationElement.append("span").html('<a href="' + formUrl + '" target="_blank">Ajoutez vos informations</a>');
            }
            else {
            ...
            //Set InterestsTarget
            if (e.Interests == null)
                d3.select("#InterestsTarget").html('<a href="' + formUrl + '" target="_blank">Ajoutez vos informations</a>');
            else
